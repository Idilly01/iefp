       ...
       <!-- Navbar with buttons -->
        ...
        <%
            ...
            try {
                    ...
                    String sql = "INSERT INTO t_categoria (categoria) VALUES (?)";
                    ...
                    String sql = "DELETE FROM t_categoria WHERE idCat=?";
                    PreparedStatement pstm = con.prepareStatement(sql);
                    pstm.setInt(1, id);
        ...
        <tr>
            ...
            <td>
                <form action="gerirCat.jsp" method="post">
        ...
        <form method="post" action="gerirCat.jsp">
            ...
            Tipo: <input type="text" name="categoria" size="20"><br>
