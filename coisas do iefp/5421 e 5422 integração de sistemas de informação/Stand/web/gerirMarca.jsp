    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <%
            ...
            try {
                    ...
                    String sql = "INSERT INTO tMarca (marca) VALUES (?)";
                    ...
                    String sql = "DELETE FROM tMarca WHERE idM=?";
                    PreparedStatement pstm = con.prepareStatement(sql);
                    pstm.setInt(1, id);
        ...
        <tr>
            ...
            <td>
                <form action="gerirMarca.jsp" method="post">
                    <input type="hidden" name="acao" value="apagar">
                    <input type="hidden" name="id" value="<%= rs.getInt("idM") %>">
        ...
        <form method="post" action="gerirMarca.jsp">
            ...
            Tipo: <input type="text" name="marca" size="20"><br>
